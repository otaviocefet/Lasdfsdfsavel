	...
	<div class="menu">
		<ul class="menu col-md-12">
			<li class="col-md-2 text-center">
				<a href="home">
					<img src="./imgs/laramusic-branca.png" alt="LaraMuic" class="logo">
				</a>
			</li>
			<li class="col-md-2 text-center">
				<a href="relatorios">
			...
			<li class="col-md-2 text-center">
				<a href="relatorios">
					<img src="./imgs/perfil-laramusic.png" alt="Meu Perfil" class="img-menu">
					<h1>Usuários</h1>
				</a>
			</li>
			<li class="col-md-2 text-center">
				<a href="relatorios">
					<img src="./imgs/sair-laramusic.png" alt="Sair" class="img-menu">
					<h1>Sair</h1>
				</a>
			</li>
		</ul>
